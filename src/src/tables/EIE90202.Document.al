...

{
    ...
    var
        ...
        DocumentLine: Record "MyDocument Line";

    PROCEDURE AssistEdit(OldDocumentHeader: Record "MyDocument Header"): Boolean;

    var

        DocumentHeader: Record "MyDocument Header";
